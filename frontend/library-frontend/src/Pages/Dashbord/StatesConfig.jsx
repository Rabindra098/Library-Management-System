...
const StatsConfig = ({ myLoans, reservations, stats }) => [
  {
    id: "loans",
    title: "Current Loans",
    ...
    icon: (
      <LibraryBooks sx={{ fontSize: 32, color: "#4F46E5" }} />
    ),
  ...
  },
  {
    ...
    icon: (
      <EventAvailableIcon sx={{ fontSize: 32, color: "#9333EA" }} />
    ),
  ...
  },
  {
    ...
    value: myLoans.length,
    icon: (
      <HistoryIcon sx={{ fontSize: 32, color: "#10B981" }} />
    ),
